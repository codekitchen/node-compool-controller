...
class StatusMessage extends Message {
    constructor(bytes) {
        ...
        this.spaDelay = (bytes[10] & 0b00000001) > 0;
        this.poolDelay = (bytes[10] & 0b00000010) > 0;
        this.poolHeaterOn = (bytes[10] & 0b00110000) > 0;
        this.spaHeaterOn = (bytes[10] & 0b11000000) > 0;
        this.poolWaterTemp = bytes[11] * 0.25;
        // TODO: only cp3830 has a separate spa water temp status
        this.spaWaterTemp = this.poolWaterTemp;
